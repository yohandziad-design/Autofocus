      ...
      <section className="relative z-10 pt-32 pb-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            coordonnées. L’envoi se fait par WhatsApp — aucune carte bancaire
            n’est requise.
          </p>
          </div>
        </div>
            ...
            <aside className="lg:col-span-1">
              <div className="card-premium p-8">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {selectedFormula
                      ? `${selectedFormula.label} — ${selectedFormula.price}€`
                      : "—"}
                  </span>
                </div>
                <div className="flex items-center justify-between">
              ...
              <div className="mt-5 border-t border-white/10 pt-5">
                ...
                <p className="tip mt-2">
                  Prix fixe par formule. Paiement sur place (espèces/CB) —
                  confirmation et adresse envoyées par WhatsApp.
                </p>
              </div>
